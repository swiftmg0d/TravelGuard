...
class HomeLogoAppBar extends StatefulWidget {
  ...
  @override
  State<HomeLogoAppBar> createState() => _HomeLogoAppBarState();
}

class _HomeLogoAppBarState extends State<HomeLogoAppBar> {
  late Timer _timer;
            ...
            Container(
              ...
              child: Text(
                ...
                style: GoogleFonts.staatliches(
                    fontSize: 16, color: Color.fromARGB(255, 19, 50, 49)),
                softWrap: true,
              ),
            ),
            Row(
